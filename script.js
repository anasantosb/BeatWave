...
window.onSpotifyWebPlaybackSDKReady = () => {
  //token = 'BQB1Spp5LjbeP29tHEd1AJRPXLgwQvU2WUqMOIPOTkFwD74nQgijGiLAnkpev4_s4zRbuxm1ei9sHz1uli61eITsTeJW8XvdMkuGmwtx1Re8rvo1uKH5vlmWGM43PuujleBSvK_aHFoAWH41R4Y1HTHNMjDBMWg9-n1v1kLGHmxrQYZd2bA-d6HYe2q4yd_scwR7ZpwttH5COKzO0DuLF3i3zY96'
  ...
  document.getElementById("play-music").addEventListener("click", (e) => {
    ...
    if (ispause === 0){
      ...
      //timeout fazia com que a musica fosse perdida em 5 segundos, depois tocava os 5 segundos restantes
      //removendo o timeout a musica volta a respeitar os 10 segundos previstos
      /*setTimeout(() => {
        tocar();
    }, 500);*/
    ispause = 1;
